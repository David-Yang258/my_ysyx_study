module wbu(
	...
	input  [`BUS_DATA_WIDTH-1:0] 	  if_npc,
	...
	output reg 	[`BUS_DATA_WIDTH-1:0] wbu_diff_npc,
...
always@(*)begin
		...
		final_reg_we  	=1'b0;
		final_rd_waddr 	=5'b0;
		final_rd_wdata 	=32'b0;
		final_csr_waddr1=12'b0;
		final_csr_waddr2=12'b0;
		final_csr_wdata1=32'b0;
		final_csr_wdata2=32'b0;
